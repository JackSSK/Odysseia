...
$a = "stable-diffusion-webui/models/Stable-diffusion/v1-5-pruned-emaonly.ckpt" 
$n_workers = 1

# Train data path | 设置训练用模型、图片
$pretrained_model = $a # base model path | 底模路径
$train_data_dir = "data/img" # train dataset path | 训练数据集路径
...
$output_name = "glock17_v0" # output model name | 模型保存名称
